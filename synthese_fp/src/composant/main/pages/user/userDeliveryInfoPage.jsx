...
const UserDeliveryInfoPage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        fetch("http://localhost:8082/api/v1/commande/delivery", {
            method: "POST",
            headers: {
                "Authorization": `Bearer ${token}`,
                "Content-Type": "application/json"
    ...
    return (
        <div style={styles.container}>
            ...
            <h2 style={styles.title}>🚚 Informations de livraison</h2>
            <p style={styles.paragraph}>
                Veuillez remplir les informations ci-dessous pour que nous puissions livrer votre commande à l’adresse
                souhaitée.
                <br/><br/>
                <em>📦 Assurez-vous que l’adresse est correcte pour éviter tout problème de livraison.</em>
            </p>

            <form onSubmit={handleSubmit} style={styles.form}>
                <div style={styles.formGroup}>
                    <label style={styles.label_1}>🏠 Adresse :</label>
                    <input
                        type="text"
                        name="address"
                        value={form.address}
                ...
                <div style={styles.formGroup}>
                    <label style={styles.label_1}>📮 Code postal :</label>
                    <input
                        type="text"
                        name="postalCode"
                ...
                <div style={styles.formGroup}>
                    <label style={styles.label_1}>🏙️ Ville :</label>
                    <input
                        type="text"
                        name="city"
                        value={form.city}
                ...
                <div style={styles.formGroup}>
                    ...
                    <select
                        ...
                        style={styles.input}
                    >
                        <option value="MAISON">Payer à la maison</option>
                ...
                {isPaymentOnline && (
                    <div style={{
                        ...
                        🕒 La commande sera livrée dans un délai de 1 à 2 heures après le paiement en ligne.
                    </div>
                )}
                {!isPaymentOnline && (
                    <div style={styles.formGroup}>
                ...
                {dateOption === "CUSTOM" && (
                    <>
                        <div style={styles.formGroup}>
                            <label style={styles.label_1}>📅 Jour de la livraison :</label>
                            <input
                                type="date"
                                name="date"
                                value={form.date}
                        ...
                        <div style={styles.formGroup}>
                            <label style={styles.label_1}>⏰ Heure Voulue :</label>
                            <input
                                type="time"
                                name="time"
                                value={form.time}
                ...
                <div style={styles.modalOverlay}>
                    <div style={styles.modalContent}>
                        {!success ? (
                            ...
                            <>
                                <h3 style={{color: "green", fontSize: "2rem"}}>✔️</h3>
...
export default UserDeliveryInfoPage;
